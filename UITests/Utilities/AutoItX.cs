...
{
    /// <summary>
    ///     Stole this from http://www.autoitscript.com/forum/topic/72905-c-use-of-the-dll-some-idears-for-you/page-2
    /// </summary>
    internal static class AutoItX
    {
        ...
        //"DLL Export Viewer" is from <a href='http://www.nirsoft.net' class='bbc_url' title='External link' rel='nofollow external'>http://www.nirsoft.net</a>
        // Definitions
        ...
        /// </summary>
        /// <param name="Option">
        ///     The option to change. See Remarks in help documentation.
        ///     CaretCoordMode
        ///     MouseClickDelay
        ///     MouseClickDownDelay
        ///     MouseClickDragDelay
        ...
        public static extern void AU3_DriveMapAdd([MarshalAs(UnmanagedType.LPWStr)] string Device
            ...
            , [MarshalAs(UnmanagedType.LPWStr)] string Pwd, [MarshalAs(UnmanagedType.LPWStr)] StringBuilder Result,
            int BufSize);
        ...
        /// <param name="Key">
        ///     Optional: The key name in the in the .ini file. If no key name is given the entire section is
        ///     deleted.
        /// </param>
        /// <returns>
        ///     Success: Returns 1.
        ...
        /// <param name="x">
        ///     (Present position Can be gotten from AU3_MouseGetPosX()) The x/y coordinates to move the mouse to. If
        ///     no x and y coords are given, the current position is used.
        /// </param>
        /// <param name="y">
        ///     (Present position Can be gotten from AU3_MouseGetPosY()) The x/y coordinates to move the mouse to. If
        ///     no x and y coords are given, the current position is used.
        /// </param>
        /// <param name="clicks">Optional: The number of times to click the mouse. Default is 1.</param>
        /// <param name="speed">
        ///     Optional: the speed to move the mouse in the range 1 (fastest) to 100 (slowest). A speed of 0 will
        ...
        /// <summary>
        ///     Searches a rectangle of pixels for the pixel color provided.  It will crash if the color is not found.  (See
        ///     AutoItX3Declarations.cs for details)
        /// </summary>
        ...
        /// <param name="Shade">
        ///     A number between 0 and 255 to indicate the allowed number of shades of variation of the red, green,
        ///     and blue components of the colour. Default is 0 (exact match).
        /// </param>
        /// <param name="Step">
        ///     Instead of searching each pixel use a value larger than 1 to skip pixels (for speed). E.g. A value
        ///     of 2 will only check every other pixel. Default is 1.
        /// </param>
        /// <param name="PointResult">
        ...
        [DllImport("AutoItX3_x64.dll", SetLastError = true, CharSet = CharSet.Auto)]
        public static extern int AU3_ProcessSetPriority([MarshalAs(UnmanagedType.LPWStr)] string Process,
            int Priority);
        ...
        public static extern void AU3_StatusbarGetText([MarshalAs(UnmanagedType.LPWStr)] string Title
            ...
            [MarshalAs(UnmanagedType.LPWStr)] StringBuilder StatusText, int BufSize);
        ...
        public static extern void AU3_WinGetClassList([MarshalAs(UnmanagedType.LPWStr)] string Title
            , [MarshalAs(UnmanagedType.LPWStr)] string Text, [MarshalAs(UnmanagedType.LPWStr)] StringBuilder RetText,
            int BufSize);
